use advent_of_code_2024::template::commands::{all, attempt, download, read, scaffold, set_year, solve, time};
...
mod args {
    use advent_of_code_2024::template::Day;
    use std::process;
    ...
    match parse() {
        ...
        Ok(args) => match args {
            ...
            AppArguments::GetYear => {
                let year = advent_of_code_2024::template::get_year_exit_on_fail();
